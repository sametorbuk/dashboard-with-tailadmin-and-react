...
import DeleteModal from "./delete-comp";

export default function ProductListPage(props) {
    const { currentBookData, setCurrentBookData } = props;
    ...
    const deleteBookHandler = (book) => {
        const filtered = currentBookData.filter((b) => b !== book);
        setCurrentBookData(filtered);
        deleteModalToggle();
    };
                        ...
                        <tbody>
                            {currentBookData.map((book, key) => (
                                <tr key={key}>
                                    ...
                                    <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                        <p className={`inline-flex rounded-full bg-opacity-10 py-1 px-3 text-sm font-medium ${book.title === 'Paid'
